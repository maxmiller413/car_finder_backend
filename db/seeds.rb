...
car1 = Car.create(vehicle_type: "Sedan", make: "Audi", model: "A7", year: 2021, price: 55000, average_vehicle_rating: 4, user_rating: nil, image: "https://media.ed.edmunds-media.com/audi/a7/2020/oem/2020_audi_a7_sedan_prestige-55-tfsi-quattro_fq_oem_1_815.jpg")
...
car3 = Car.create(vehicle_type: "SUV", make: "Audi", model: "RS Q8", year: 2021, price: 55000, average_vehicle_rating: 4, user_rating: nil, image: "https://www.motortrend.com/uploads/sites/5/2019/12/2021-Audi-RS-Q8-13.jpg")
...
car5 = Car.create(vehicle_type: "SUV", make: "Audi", model: "R8", year: 2021, price: 55000, average_vehicle_rating: 4, user_rating: nil, image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/2021-audi-q3-mmp-1-1590773404.jpg")

car6 = Car.create(vehicle_type: "SUV", make: "Mercedes-Benz", model: "G-Class", year: 2021, price: 50000, average_vehicle_rating: 4, user_rating: nil, image: "https://www.autocar.co.uk/sites/autocar.co.uk/files/styles/gallery_slide/public/1-mercedes-benz-g-class-2019-rt-hero-front.jpg?itok=pUqbqeDN")
...
car9 = Car.create(vehicle_type: "SUV", make: "Mercedes-Benz", model: "GLS", year: 2021, price: 50000, average_vehicle_rating: 4, user_rating: nil, image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/2021-mercedes-benz-gls-class-mmp-1-1601408956.jpg")

car10 = Car.create(vehicle_type: "Convertible", make: "Mercedes-Benz", model: "SL Roadster", year: 2021, price: 50000, average_vehicle_rating: 4, user_rating: nil, image: "https://www.latestcarnews.net/wp-content/uploads/2021/01/Mercedes-SL-2021-2.jpg")
...
car14 = Car.create(vehicle_type: "SUV", make: "Porsche", model: "Macan", year: 2021, price: 45000, average_vehicle_rating: 5, user_rating: nil, image: "https://cdn.motor1.com/images/mgl/Q0QyB/s3/2021-porsche-macan-ev-rendering.jpg")

car15 = Car.create(vehicle_type: "SUV", make: "Porsche", model: "Cayenne", year: 2021, price: 45000, average_vehicle_rating: 5, user_rating: nil, image: "https://media.ed.edmunds-media.com/porsche/cayenne-coupe/2021/oem/2021_porsche_cayenne-coupe_4dr-suv_gts_fq_oem_5_1600.jpg")

car16 = Car.create(vehicle_type: "SUV", make: "BMW", model: "X7", year: 2021, price: 60000, average_vehicle_rating: 4, user_rating: nil, image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/2019-bmw-x7-1550161348.jpg")

car17 = Car.create(vehicle_type: "Sedan", make: "BMW", model: "Z4", year: 2021, price: 60000, average_vehicle_rating: 4, user_rating: nil, image: "https://i.gaw.to/vehicles/photos/40/24/402459-2021-bmw-z4.jpg")

car18 = Car.create(vehicle_type: "SUV", make: "BMW", model: "X2", year: 2021, price: 60000, average_vehicle_rating: 4, user_rating: nil, image: "https://mediapool.bmwgroup.com/cache/P9/202005/P90389832/P90389832-the-new-bmw-x2-xdrive25e-phytonic-blue-metallic-rim-19-styling-722-m-05-2020-2250px.jpg")
